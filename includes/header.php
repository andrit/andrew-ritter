...
<head>
	...
	<title>Web Designer, UX Designer, Creative Writer</title>
	<link rel="stylesheet" href="css/bootstrap.min.css">
	<link rel="stylesheet" href="css/gunmetalCSS.css">
...
<header class="container">
	 <div id="menu" class="navbar navbar-default navbar-fixed-top">
			...
			<button id="trigger-overlay" class="btn btn-info pull-right" type="button"><img class="navmap" alt="Menu"/></button>
			
			<div id="logo">
					<a href="index.php" class="navbar-brand pull-left"><img src="img/ARlogo.svg" alt="AndrewRitter.me" /></a>
			</div>
		</div>	
		...
		<div class="overlay overlay-boxes">
			...
			<button type="button" class="overlay-close">Close</button>
					...
					<nav role="navigation">
						<li class="nav"><a href="index.php"><i class="glyphicon glyphicon-home"></i> Home</a></li>
						<li class="nav"><a href="photography.php"><i class="glyphicon glyphicon-camera"></i> Photography</a></li>
						<li class="nav"><a href="work.php"><i class="glyphicon glyphicon-briefcase"></i> My Work</a></li>
						<li class="nav"><a data-toggle="modal" data-target="#myModal" href="#"><i class="glyphicon glyphicon-envelope"></i> Contact</a></li></ul>
				</nav>
	</header>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body text-center">
        <h2><span class="fa fa-cog fa-spin"></span> Need some help on a design project?</h2>
        <p>Send me an email with the information and I'll get back to you ASAP</p>
        <h4>arnewmediatech@gmail.com</h4>
      </div>
      <form action=""></form>
